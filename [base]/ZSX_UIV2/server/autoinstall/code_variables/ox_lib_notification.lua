...
function lib.notify(data)
    ...
    exports['ZSX_UIV2']:Notification(data.title or 'Notification', data.description or '', data.icon and data.icon or (data.type and iconsFromType[data.type] or false), data.duration)
