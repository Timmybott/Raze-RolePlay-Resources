...
doc.getElementById('cancel').addEventListener('click', e => {
    ...
    e.target.style.backgroundColor = "var(--accent-bright)";
    setTimeout(() => {
...
doc.getElementById('delete').addEventListener('mouseover', _ => changeInfo(true, 'Reset all', 'Resets all animations, props and walkstyles.'));
