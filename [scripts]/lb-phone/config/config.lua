...
Config.Companies.Services = {
    {
        ...
        bossRanks = { "chief_of_police", "assistant_chief_of_police" }, -- ranks that can manage the company
        location = {
            name = "Mission Row",
            coords = {
                x = 428.9,
    ...
    },
    {
        ...
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = { "chief_of_medicine", "assistant_chief" }, -- ranks that can manage the company
        location = {
            name = "LSMD",
            coords = {
                x = -323.3196,
...
Config.DateLocale = "de-DE" -- https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat/DateTimeFormat
